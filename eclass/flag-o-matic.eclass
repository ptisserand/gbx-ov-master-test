...
# @FUNCTION: harden-stack-protector
# @DESCRIPTION:
# If actual C/CXX FLAGS has -fstack-protector, replace it with
# -fstack-protector-all
harden-stack-protector() {

	is-flagq -fstack-protector && replace-flags -fstack-protector -fstack-protector-all
